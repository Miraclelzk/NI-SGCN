...
from models_NI_PSGCN.denoise_Noisy import *
from models_NI_PSGCN.utils_Noisy import chamfer_distance_unit_sphere
...
save_title = '{dataset}_Ours{modeltag}_{tag}_{res}_{noise}_{T}_{time}'.format_map({
...
model = DenoiseNet_snn_Noisy(ckpt['args']).to(args.device)
